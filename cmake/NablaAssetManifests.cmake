...
function(nam_add_channel_target)
    ...
    if (_archive_refs)
        ...
        foreach(_index RANGE ${_archive_last})
            ...
            add_custom_command(
                OUTPUT "${_stamp}"
                COMMAND "${CMAKE_COMMAND}" -DTYPE=archive -DINPUT=${_expanded_path} -DDESTINATION=${_target_path} -DNO_SYMLINKS=$<BOOL:${NAM_NO_SYMLINKS}> -P "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/NablaAssetManifestsMaterialize.cmake"
